                ...
                <div  class="modal-dialog">
                    <div class="modal-content">
                        <form action="edit" method="post">
                            <div style="background-color:  #ffb700" class="modal-header">						
                                <h4 style="color: white" class="modal-title">Add Product</h4>
                            ...
                            <div style="background-color:  #ffb700" class="modal-footer">
